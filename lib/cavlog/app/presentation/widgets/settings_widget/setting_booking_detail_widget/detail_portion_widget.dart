...
import 'package:barber_pannel/cavlog/app/presentation/widgets/settings_widget/setting_booking_detail_widget/clipchip_marker_widget.dart';
import 'package:barber_pannel/cavlog/app/presentation/widgets/settings_widget/setting_booking_detail_widget/detail_payment_summary_text_widget.dart' show paymentSummaryTextWidget;
            ...
            paymentSummaryTextWidget(
              ...
              prefixTextStyle: GoogleFonts.plusJakartaSans(
                  ...
                  color: () {
                    ...
                    if (status == 'credited') return AppPalette.redClr;
                    if (status == 'debited') return AppPalette.greenClr;
                  }()),
